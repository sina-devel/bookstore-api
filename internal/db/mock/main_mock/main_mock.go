...
func (m *MockMainRepository) AddUser(user *models.User) (*models.User, *models.Wallet, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMainRepositoryMockRecorder) AddUser(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddUser", reflect.TypeOf((*MockMainRepository)(nil).AddUser), user)
}
...
// AddUser mocks base method.
func (m *MockUserRepository) AddUser(user *models.User) (*models.User, *models.Wallet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddUser", user)
	ret0, _ := ret[0].(*models.User)
	ret1, _ := ret[1].(*models.Wallet)
